                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-12 col-sm-12 mb-3" valign="middle">
                            <div class="white-box text-center border"><img src="Product/<?php echo $pic ?>" class="img-responsive" height="100%" width="100%"></div>
                        </div>
                        <div class="col-lg-6 col-md-12 col-sm-12 mt-xl-4">
                            ...
                            <form action="?page=cart" method="POST" class="mb-2">
                                <div class="row d-flex">
                                    ...
                                    <input type="submit" name="btnFeedback" formaction="?page=feedback&id=<?php echo $id ?>" class="btn btn-warning btn-rounded col-md-3" value="Feedback">
                                </div>
